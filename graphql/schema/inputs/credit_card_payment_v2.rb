class Spree::GraphQL::Schema::Inputs::CreditCardPaymentV2 < Spree::GraphQL::Schema::Types::BaseInput
  graphql_name 'CreditCardPaymentInputV2'
  description %q{Specifies the fields required to complete a checkout with
a Store vaulted credit card payment.
}

  
  include ::Spree::GraphQL::Inputs::CreditCardPaymentV2
  ...
  argument :vault_id, ::GraphQL::Types::String, required: true, description: %q{The ID returned by Store's Card Vault.}
