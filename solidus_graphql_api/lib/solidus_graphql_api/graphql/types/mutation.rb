module Spree::GraphQL::Types::Mutation
  ...
  # Args: checkout_id, customer_access_token
  ...
  # Args: discount_code, checkout_id
  ...
  # Args: applied_gift_card_id, checkout_id
  ...
  # Args: gift_card_codes, checkout_id
  ...
  # Args: checkout_id, line_item_ids
  ...
  # Args: shipping_address, checkout_id
  ...
  # Args: checkout_id, shipping_rate_handle
  ...
  # Args: customer_access_token, address
  ...
  # Args: customer_access_token, id, address
  ...
  # Args: customer_access_token, address_id
  ...
  # Args: customer_access_token, customer
