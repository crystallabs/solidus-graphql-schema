        ...
        chain.each do |t2|
          if t2['kind'] == 'NON_NULL' and !t2['name']; string.sub! /true$/, 'false'
            ...
            if (new_name != ret_name) && ($catalog[:depends][ret_name]) && ($catalog[:depends][ret_name][new_name])
              ...
              helper['preamble']= "class Spree::GraphQL::Schema::#{ret_name} < Spree::GraphQL::Schema::Types::BaseObject; end\n\n"
            end
            ...
            string = "#{ret_name}, null: true"
				...
				if helper['preamble']
					$catalog[:schema_contents][new_name].unshift helper['preamble']
					helper['preamble']= nil
				end
...
'schema' => "class Spree::GraphQL::Schema < GraphQL::Schema
